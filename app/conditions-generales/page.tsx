...
export const metadata: Metadata = {
  ...
  description: "Conditions générales de location applicables aux véhicules NL Prestige.",
    ...
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-brand-silver">
        <section>
          ...
          <p className="mt-2">
            Les présentes conditions générales encadrent la location de véhicules proposée par Bull
            Rent, en courte comme en longue durée. Elles seront acceptées par le client avant toute
        ...
        <section>
          ...
          <p className="mt-2 text-xs text-brand-silver/70">
            ...
            précisément par NL Prestige pour chaque catégorie de véhicule.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-xs text-brand-silver/70">
            ...
            par NL Prestige avant publication.
          </p>
        </section>
      </div>
    </div>
