...
export const bullrent: BrandConfig = {
  id: "bullrent",
  name: "Bull Rent",
  legalName: "Bull Rent Sàrl", // TODO: remplacer par la raison sociale officielle
  tagline: "Location de véhicules de luxe à Genève.",
  description:
  ...
  url: "https://www.bullrent.ch", // TODO: remplacer par le nom de domaine officiel
  ...
  images: {
    hero: "/brands/bullrent/hero.svg",
    about: "/brands/bullrent/about.svg",
  },

  contact: {
    email: "info@bullrent.ch", // TODO: remplacer par l'adresse e-mail officielle
    ...
    whatsappDefaultMessage:
      "Bonjour Bull Rent, je souhaiterais obtenir des informations concernant la location d'un véhicule.",
  },

  social: {
    instagram: "https://www.instagram.com/bullrent.ch",
  },
