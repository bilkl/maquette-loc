    ...
    <footer className="border-t border-brand-line bg-brand-charcoal">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p className="text-lg font-black uppercase tracking-tight text-brand-ivory">
          ...
          <div>
            <h2 className="text-sm font-bold uppercase tracking-wide text-brand-ivory">Coaching</h2>
          ...
          <div>
            <h2 className="text-sm font-bold uppercase tracking-wide text-brand-ivory">Nous joindre</h2>
          ...
          <div>
            <h2 className="text-sm font-bold uppercase tracking-wide text-brand-ivory">Horaires</h2>
