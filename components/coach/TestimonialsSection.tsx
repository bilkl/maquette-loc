...
import type { CoachContent, CoachTestimonial } from "@/data/coach";
import { SectionTitle } from "@/components/ui/SectionTitle";

interface TestimonialsSectionProps {
  content: CoachContent["testimonials"];
}
...
function TestimonialCard({ testimonial }: { testimonial: CoachTestimonial }) {
  return (
