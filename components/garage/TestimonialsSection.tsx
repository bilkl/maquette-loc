...
import type { GarageContent, GarageTestimonial } from "@/data/garage";
import { SectionTitle } from "@/components/ui/SectionTitle";

interface TestimonialsSectionProps {
  content: GarageContent["testimonials"];
}
...
function TestimonialCard({ testimonial }: { testimonial: GarageTestimonial }) {
  return (
