...
export function AppointmentSection({ content, services, defaultServiceSlug }: AppointmentSectionProps) {
  const mapsUrl = externalHref(siteConfig.address.mapsUrl);

  return (
    <section id="rendez-vous" className="scroll-mt-20 bg-brand-charcoal py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-14">
          ...
          <GarageAppointmentForm services={services} defaultServiceSlug={defaultServiceSlug} />
        </div>
      </div>
    </section>
  );
