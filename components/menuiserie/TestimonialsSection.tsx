...
import type { MenuiserieContent, MenuiserieTestimonial } from "@/data/menuiserie";
import { SectionTitle } from "@/components/ui/SectionTitle";

interface TestimonialsSectionProps {
  content: MenuiserieContent["testimonials"];
}
...
function TestimonialCard({ testimonial }: { testimonial: MenuiserieTestimonial }) {
  return (
    <figure className="flex h-full flex-col rounded-xl border border-brand-line bg-brand-black p-6">
