...
import { ImmobilierMobileMenu } from "@/components/immobilier/ImmobilierMobileMenu";
import { cn } from "@/lib/utils";

/**
 * En-tête du gabarit "immobilier" : sobre et sticky, avec un accès direct au
 * catalogue et à l'estimation gratuite — les deux parcours mis en avant dès
 * le hero (voir components/dealer/DealerHeader.tsx pour le même parti pris).
 */
export function ImmobilierHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-brand-line bg-brand-black/95 backdrop-blur-sm">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden sm:block">
            <ImmobilierLinkButton href="/#estimation" variant="primary">
              Estimation gratuite
      ...
      <ImmobilierMobileMenu isOpen={isMenuOpen} onClose={() => setIsMenuOpen(false)} />
    </header>
  );
}
