...
interface EstimateSectionProps {
  content: ImmobilierContent["estimate"];
}

export function EstimateSection({ content }: EstimateSectionProps) {
  const mapsUrl = externalHref(siteConfig.address.mapsUrl);

  return (
    <section id="estimation" className="scroll-mt-20 bg-brand-black py-16 sm:py-20">
