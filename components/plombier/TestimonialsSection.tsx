...
import type { PlombierContent, PlombierTestimonial } from "@/data/plombier";
import { SectionTitle } from "@/components/ui/SectionTitle";

interface TestimonialsSectionProps {
  content: PlombierContent["testimonials"];
}
...
function TestimonialCard({ testimonial }: { testimonial: PlombierTestimonial }) {
  return (
