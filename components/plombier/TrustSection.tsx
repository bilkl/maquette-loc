...
import { valueIcons } from "@/components/plombier/icons";

interface TrustSectionProps {
  content: PlombierContent["trust"];
}

/** Section confiance : 20 ans d'expérience, intervention rapide, travail soigné — en grille d'icônes aérée. */
