 ...
 * confirmées par Eagle Drive avant toute publication définitive.
 */
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "La location longue durée est construite sur mesure selon votre profil et vos besoins. Un conseiller Eagle Drive revient vers vous après votre demande pour établir une offre personnalisée.",
  },
  {
